...
export const countriesInfo = {
    ...
    malaysia: {
        ...
        facts: {
            items: [
                'валютой является малайзийский рингет (MYR), который стоит от 4 MYR до 1 доллара США.',
                'Малайзия — мультикультурная, но преимущественно исламская страна.',
                'воду, как правило, безопасно пить прямо из-под крана. ',
                'Малайзия имеет один из самых высоких показателей биоразнообразия в мире, где обитает около 20% видов животных в мире.'],
            image: facts,
        },
        ...
        eating: {
            title: 'Кухня',
            text: 'Среди традиционных блюд страны можно отметить Наси Лемак (кокосовый рис, приготовленный с листьями пандана и заправленный соусом чили или другим малазийским карр), Икан Бакар (маринованная рыба или морепродукты на гриле, приправленные соусом чили, завернутые в банановые листья и приготовленные на углях), Наси кандар (состоит из пропаренного риса, карри в индийском стиле и различных белковых блюд.',
    ...
    singapore: {
        ...
        facts: {
            items: [
                'валютой Сингапура является сингапурский доллар (SGD), который составляет около 1,50 SGD за 1 доллар США.',
        ...
        eating: {
            title: 'Кухня',
            text: 'Среди традиционных блюд страны можно отметить краб с чили (сладкое и соленое блюдо, приготовленное из морепродуктов), Kaya Toast – блюдо, получившее свое название от уникального домашнего варенья, которое используется в качестве намазки на поджаренный хлеб. Также популярным блюдом является лакса - рисовая лапша в кокосовом соусе карри с морепродуктами или другими вариантами белка, обычно очень острая.',
        ...
        visits: {
            ...
            recomendations: [
                ...
                },
                {
                    ...
                    description: 'Будучи старейшим музеем Сингапура, он станет центром истории и богатой культуры народа.',
                    image: {
    ...
    indonesia: {
        ...
        facts: {
            items: [
                'валютой Индонезии является индонезийская рупия (IDR), которая составляет около 13 000 IDR за 1 доллар США.',
                'в Индонезии можно найти одни из лучших мест для дайвинга в мире',
                'ислам — самая популярная религия в Индонезии, почти 80% населения мусульмане.',
                'страна является одной из основных стран-производителей арахиса. ',
                'одним из самых главных мест в Индонезии является Бали — остров, созданный вулканами. '],
            image: facts,
        },
    ...
    vietnam: {
        ...
        facts: {
            items: [
                'вьетнамской валютой является вьетнамский донг (VND), который стоит около 2000 донгов за 1 доллар США.',
                'во Вьетнаме одно из самых дешевых сортов пива в мире — стакан bia hoi может стоить всего 0,16 доллара США.',
                'вьетнам занимает второе место в мире по потреблению риса на душу населения.',
                'вьетнамские джунгли — чрезвычайно опасное место',
                'вьетнамцы не любят загорать, ценится светлая кожа'],
            image: facts,
        },
        ...
        accomodation: {
            ...
            items: [
                {
                    title: 'Бюджетный вариант', 
                    text: 'Возможно, вам придется потратить в среднем около 20 долларов, чтобы остаться во Вьетнаме с ограниченным бюджетом. Самая дешевая форма проживания во Вьетнаме — это матрас в общежитии, где вы платите за матрас и пользуетесь обычными удобствами.',
                    id: '1',
                },
        ...
        eating: {
            title: 'Кухня',
            text: 'Среди традиционных блюд страны можно отметить фо-бо (суп), ча-ка (рыба на гриле). Также национальным блюдом ялвется као лау, которое готовят из рисовой лапши, свинины и зелени, и рау муонг - жареный водяной шпинат.',
        ...
        visits: {
            ...
            recomendations: [
                {
                    destination: 'Тайнинь',
                    description: 'Посетите церковь в Тайнинь — Тайнинь, оживленный город в дельте Меконга, в котором расположены одни из самых красивых церквей и соборов в стране.',
                    image: {
                ...
                {
                    destination: 'Халонг',
                    description: 'Посетите бухту Халонг – расположен примерно в 165 км к востоку от Ханоя в Тонкинском заливе.',
                    image: {
