...
export const countriesInfo = {
    italy: {
        ...
        facts: {
            items: [
                    {
                        item: 'валюта: официальной валютой является евро, 1 евро и составляет от 1 евро до 1,35 доллара США;',
                        id: '1'
                    },
                    {
    ...
    france: {
        ...
        facts: {
            items: [
                    ...
                    {
                        item: 'во Франции находится самое большое количество замков в мире — всего 4 969 штук;',
                        id: '2'
                    },
                    {
    ...
    spain: {
        ...
        facts: {
            items: [
                ...
                'Испания - это королевство, cтраной правит король, правда, только номинально;',
                ...
                'футбол считается национальным видом спорта'],
            image: facts,
        },
    ...
    portugal: {
        ...
        facts: {
            items: [
                'валюта: официальной валютой является евро, 1 евро и составляет от 1 евро до 1,35 доллара США;',
                'первое упоминание о Португалии датируется 868 годом;',
                'столица Лиссабон – древнейший из городов Западной Европы;',
                'на территории Португалии производят знаменитое крепленое вино «Портвейн»;',
                'единственная европейская страна, границы которой остаются неизменными с 1139 года.'],
            image: facts,
        },
    ...
    czech: {
        ...
        facts: {
            items: [
                ...
                'cnhfyf имеет наиболее успешную и стабильную экономику среди стран бывшего коммунистического лагеря',
    ...
    germany: {
        ...
        facts: {
            items: [
                'валюта: официальной валютой является евро, 1 евро и составляет от 1 евро до 1,35 доллара США;',
                'гимн Германии написан в 1841 году;',
                'западная и Восточная Германия объединились в 1990 году;',
                'в стране существует около 1500 видов колбас, 300 видов хлеба и примерно 5 тысяч сортов пива;',
                '80% автомобилей такси это - Mercedes Benz.'],
            image: facts,
        },
    ...
    china: {
        ...
        facts: {
            items: [
                ...
                'страна является второй самой густонаселенной страной в мире и насчитывает 1,4 млрд жителей;',
                'самое популярное имя в Китае – Ван (Wang).'],
            image: facts,
        },
    ...
    tailand: {
        ...
        facts: {
            items: [
                ...
                'Бангкок – самый посещаемый город в мире. '],
            image: facts,
        },
    ...
    malaysia: {
        ...
        facts: {
            items: [
                ...
                'страна имеет один из самых высоких показателей биоразнообразия в мире, где обитает около 20% видов животных в мире;',
                'одна пятая часть всего населения Малайзии — китайцы.'],
            image: facts,
        },
    ...
    singapore: {
        ...
        facts: {
            items: [
                ...
                'символом страны является орхидея;',
                'расположен Сингапур на острове, но де-юре в его состав входят ещё 63 мелких островка;',
                'порт страны может вместить до тысячи судов одновременно.'],
            image: facts,
        },
    ...
    indonesia: {
        ...
        facts: {
            items: [
                ...
                'ислам — самая популярная религия в стране, почти 80% населения мусульмане;',
    ...
    vietnam: {
        ...
        facts: {
            items: [
                ...
                'страна занимает второе место в мире по потреблению риса на душу населения;',
