    ...
    return (
        <article className={styles.wrapper}>
            ...
            <section className={`${styles.segment} ${styles.segment_position}`}>
                ...
                <img className={styles.imageCover} src={countriesInfo.italy.image.src} alt={countriesInfo.italy.image.alt}  />
            </section>

            <section className={`${styles.segment} ${styles.segment_position}`}>
                <img className={styles.imageFacts} src={countriesInfo.italy.facts.image.src} alt={countriesInfo.italy.facts.image.src} />
